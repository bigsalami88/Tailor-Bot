...
class Music:
    ...
    async def wtf(self, ctx):
        ...
        try:
            link = 'https://www.youtube.com/watch?v=UBQP9gEldRk#t=3'
    ...
    async def why(self, ctx):
        ...
        try:
            link = 'https://www.youtube.com/watch?v=W6oQUDFV2C0'
            player = await state.voice.create_ytdl_player(link, ytdl_options=opts, after=state.toggle_next)
        except Exception as e:
            fmt = 'An error occurred while processing this request: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
    ...
    async def action(self, ctx):
        ...
        try:
            link = 'https://www.youtube.com/watch?v=Rx3g6SU_Rms'
            player = await state.voice.create_ytdl_player(link, ytdl_options=opts, after=state.toggle_next)
        except Exception as e:
            fmt = 'An error occurred while processing this request: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
    ...
    async def vjemmie(self, ctx):
        ...
        try:
            link = 'https://www.youtube.com/watch?v=jGl5K63CLlQ'
            player = await state.voice.create_ytdl_player(link, ytdl_options=opts, after=state.toggle_next)
        except Exception as e:
            fmt = 'An error occurred while processing this request: ```py\n{}: {}\n```'
            await self.bot.send_message(ctx.message.channel, fmt.format(type(e).__name__, e))
